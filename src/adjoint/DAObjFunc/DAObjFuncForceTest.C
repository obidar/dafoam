...
defineTypeNameAndDebug(DAObjFuncForceTest, 0);
addToRunTimeSelectionTable(DAObjFunc, DAObjFuncForceTest, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAObjFuncForceTest::DAObjFuncForceTest(
    const fvMesh& mesh,
...
void DAObjFuncForceTest::calcObjFunc(
...
void DAObjFuncForceTest::updateForceDir(vector& forceDir)
{
    /*
    Description:
